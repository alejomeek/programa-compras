...
| D4 | **Numeración y PDF de OC** (§15.4): formato del consecutivo; ¿requiere IVA/flete/vencimiento/condiciones de pago?; ¿una OC por punto o consolidada por proveedor? | **Cerrado para Fase 4:** una OC por ubicación; consecutivo `OC-YYYY-UBICACION-NNNN` (serial global anual); PDF con cantidades, costos y totales solamente, sin IVA/flete/vencimiento/condiciones. Cualquier rol autenticado puede cancelar una emitida, con motivo obligatorio. | ~~Fase 4~~ decisiones cerradas |
